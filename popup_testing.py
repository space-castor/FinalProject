...
mapping = gpd.read_file("back_end_data/mapping_inequality/geojson_DEN.json")
...
# abbreviations for data adjustment from base example
"""
...
# data adjustment from base example
"""
